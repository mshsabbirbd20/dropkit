...
export default function PackView({ pack }: { pack: LearningPack }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <section className="mt-8 border border-accent/50 bg-accent/10 px-6 py-6">
        ...
        <div className="mt-5">
          <DownloadKitButton pack={pack} />
        </div>
      </section>

      <section className="mt-8 border border-ink-border bg-ink-raised px-6 py-5">
        <h2 className="font-display text-lg font-medium">After you download</h2>
        <ol className="mt-3 space-y-3 text-sm leading-relaxed">
          ...
          <li className="flex gap-3">
            ...
            <span>
              In Cursor:{" "}
              <strong className="text-paper">File → Open Folder</strong> →
